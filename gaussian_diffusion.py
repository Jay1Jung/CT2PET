...
from utils import exists, default, is_list_str
from schedules import extract, cosine_beta_schedule
from video_dataset import normalize_img, unnormalize_img
...
class GaussianDiffusion(nn.Module):
    ...
    def sample(self, cond=None, cond_scale=1., batch_size=16):
        ...
        return self.p_sample_loop(
            (batch_size, self.channels, self.num_frames, image_size, image_size),
            cond=cond,
            cond_scale=cond_scale
        )
    ...
    def p_losses(self, x_start, t, cond=None, noise=None, **kwargs):
        *_, device = *x_start.shape, x_start.device
        noise = default(noise, lambda: torch.randn_like(x_start))
